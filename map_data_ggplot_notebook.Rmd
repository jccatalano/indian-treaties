...
#creating a new data table to include all treaties. Need to make to data tables match to bind. 
...
ggplot(map_data_2) + 
      geom_polygon(aes(x = long, y = lat, group = group), data = states_df, fill = "white", color = "black") +
  geom_point(aes(x = longitude_negotiated_a, y = latitude_negotiated_a)) + 
  geom_point(aes(x = longitude_negotiated_b, y = latitude_negotiated_b)) +
      geom_segment(aes(x = longitude_negotiated_a, y = latitude_negotiated_a, xend = longitude_negotiated_b, yend = latitude_negotiated_b)) + 
      coord_map() + 
...
ggplot(map_data) + 
      geom_polygon(aes(x = long, y = lat, group = group), data = states_df, fill = "white", color = "black") +
  geom_point(aes(x = longitude_location_a, y = latitude_location_a), color = "blue") + geom_point(aes(x = longitude_location_b, y = latitude_location_b), color = "blue")+
      geom_segment(aes(x = longitude_negotiated_a, y = latitude_negotiated_a, xend = longitude_negotiated_b, yend = latitude_negotiated_b)) + 
      coord_map() + 
      labs(title= "Map of Language Borrowring by Location of Negotiation") + facet_wrap(~decade_a)
```


```{r}

ggplot(map_data) + geom_polygon(aes(x = long, y = lat, group = group), data = states_df, fill = "white", color = "black") + geom_point(aes(x = longitude_location_a, y = latitude_location_a), color = "blue") + geom_point(aes(x = longitude_location_b, y = latitude_location_b), color = "blue") + geom_segment(aes(x = longitude_location_a, y = latitude_location_a, xend = longitude_location_b, yend = latitude_location_b)) + coord_map()
