...
V(G)$color <- ifelse(V(G)$decade == "177", "blue", 
                     ifelse(V(G)$decade == "178","cyan", 
                     ifelse(V(G)$decade == "179","blueviolet", 
                     ifelse(V(G)$decade == "180","darkgreen", 
                     ifelse(V(G)$decade == "181","green", 
                     ifelse(V(G)$decade == "182","orange", 
                     ifelse(V(G)$decade == "183","gold", 
                     ifelse(V(G)$decade == "184","red", 
                     ifelse(V(G)$decade == "185","hotpink", 
                     ifelse(V(G)$decade == "186","yellow", 
                     ifelse(V(G)$decade == "187","black", 
                     ifelse(V(G)$decade == "188","tan", "white"))))))))))))
...
```{r}
readRDS("nation_graph.rds")

V(nation_graph)$color <- ifelse(V(nation_graph)$decade == "177", "blue",
                         ifelse(V(nation_graph)$decade == "178","cyan",
                         ifelse(V(nation_graph)$decade == "179","blueviolet",
                         ifelse(V(nation_graph)$decade == "180","darkgreen",
                         ifelse(V(nation_graph)$decade == "181","green",
                         ifelse(V(nation_graph)$decade == "182","orange",
                         ifelse(V(nation_graph)$decade == "183","gold",
                         ifelse(V(nation_graph)$decade == "184","red",
                         ifelse(V(nation_graph)$decade == "185","hotpink",
                         ifelse(V(nation_graph)$decade == "186","yellow",
                         ifelse(V(nation_graph)$decade == "187","black",
                         ifelse(V(nation_graph)$decade == "188","tan", "white"))))))))))))
...
V(com_0554_graph)$color <- ifelse(V(com_0554_graph)$decade == "177", "blue",
                           ifelse(V(com_0554_graph)$decade == "178","cyan",
                           ifelse(V(com_0554_graph)$decade == "179","blueviolet",
                           ifelse(V(com_0554_graph)$decade == "180","darkgreen",
                           ifelse(V(com_0554_graph)$decade == "181","green",
                           ifelse(V(com_0554_graph)$decade == "182","orange",
                           ifelse(V(com_0554_graph)$decade == "183","gold",
                           ifelse(V(com_0554_graph)$decade == "184","red",
                           ifelse(V(com_0554_graph)$decade == "185","hotpink",
                           ifelse(V(com_0554_graph)$decade == "186","yellow",
                           ifelse(V(com_0554_graph)$decade == "187","black",
                           ifelse(V(com_0554_graph)$decade == "188","tan", "white"
                           ))))))))))))
