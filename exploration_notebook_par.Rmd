...
legend("left", c("1770s","1780s", "1790s","1800s", "1810s", "1820s", "1830s", "1840s", "1850s", "1860s", "1870s", "1880s"),  pch=21,
       col=c("blue", "cyan", "darkmagenta", "darkgreen", "green", "orange", "springgreen2", "red", "hotpink","yellow", "black", "tan")) 
```
...
plot(G, 
     ...
     main = "Network Graph of Treaty Borrowing",
     edge.width = fd_matches$n)
legend("left", c("1770s","1780s", "1790s","1800s", "1810s", "1820s", "1830s", "1840s", "1850s", "1860s", "1870s", "1880s"),  pch=21, pt.cex=2, cex=.8,
       pt.bg=c("blue", "cyan", "darkmagenta", "darkgreen", "green", "orange", "springgreen2", "red", "hotpink","yellow", "black", "tan"))
```

```{r}
colrs <- c("blue", "cyan", "darkmagenta", "darkgreen", "green", "orange", "springgreen2", "red", "hotpink","yellow", "black", "tan")

V(G)$color <- colrs[V(G)$decade]

legend(x=-1.5, y=-1.1, c("Newspaper","Television", "Online News"), pch=21,

       col="#777777", pt.bg=colrs, pt.cex=2, cex=.8, bty="n", ncol=1)

legend("left", c("1770s","1780s", "1790s","1800s", "1810s", "1820s", "1830s", "1840s", "1850s", "1860s", "1870s", "1880s"), cex=0.8, fill=colors) 

t.bg= c("blue", "cyan", "darkmagenta", "darkgreen", "green", "orange", "springgreen2", "red", "hotpink","yellow", "black", "tan")
...
colors <- c("blue", "cyan", "darkmagenta", "darkgreen", "green", "orange", "springgreen2", "red", "hotpink","yellow", "black", "tan")

decades <- c("1770s","1780s", "1790s","1800s", "1810s", "1820s", "1830s", "1840s", "1850s", "1860s", "1870s", "1880s")

#Failed Attempt at ggnet.

ggnet2(G, size = 6, color = "colors", edge.size = 1, edge.color = "black")



G %v% "color" = ifelse(G$decade == "177", "blue", ifelse(G$decade == "178","cyan", ifelse(V(G)$decade == "179","darkmagenta", ifelse(V(G)$decade == "180","darkgreen", ifelse(V(G)$decade == "181","green", ifelse(V(G)$decade == "182","orange", ifelse(V(G)$decade == "183","springgreen2", ifelse(V(G)$decade == "184","red", ifelse(V(G)$decade == "185","hotpink", ifelse(V(G)$decade == "186","yellow", ifelse(V(G)$decade == "187","black", ifelse(V(G)$decade == "188","tan", "white" ))))))))))))

G  = ifelse(V(G)$decade == "177", "blue", ifelse(V(G)$decade == "178","cyan", ifelse(V(G)$decade == "179","darkmagenta", ifelse(V(G)$decade == "180","darkgreen", ifelse(V(G)$decade == "181","green", ifelse(V(G)$decade == "182","orange", ifelse(V(G)$decade == "183","springgreen2", ifelse(V(G)$decade == "184","red", ifelse(V(G)$decade == "185","hotpink", ifelse(V(G)$decade == "186","yellow", ifelse(V(G)$decade == "187","black", ifelse(V(G)$decade == "188","tan", "white" ))))))))))))
