...
get_nation <- filter(similarities3, nation_a %in% "del",
              nation_b %in% "del")
...
nation_node <- filter(node_df, nation %in% "del")

nation_graph<- graph_from_data_frame(d = get_nation, vertices = nation_node, directed = FALSE)

#saveRDS(nation_graph, "nation_graph.rds")
...
V(nation_graph)$color <- ifelse(V(nation_graph)$decade == "177", "blue", ifelse(V(nation_graph)$decade == "178","cyan", ifelse(V(nation_graph)$decade == "179","blueviolet", ifelse(V(nation_graph)$decade == "180","darkgreen", ifelse(V(nation_graph)$decade == "181","green", ifelse(V(nation_graph)$decade == "182","orange", ifelse(V(nation_graph)$decade == "183","gold", ifelse(V(nation_graph)$decade == "184","red", ifelse(V(nation_graph)$decade == "185","hotpink", ifelse(V(nation_graph)$decade == "186","yellow", ifelse(V(nation_graph)$decade == "187","black", ifelse(V(nation_graph)$decade == "188","tan", "white" ))))))))))))
...
V(com_0554_graph)$color <- ifelse(V(com_0554_graph)$decade == "177", "blue", ifelse(V(com_0554_graph)$decade == "178","cyan", ifelse(V(com_0554_graph)$decade == "179","blueviolet", ifelse(V(com_0554_graph)$decade == "180","darkgreen", ifelse(V(com_0554_graph)$decade == "181","green", ifelse(V(com_0554_graph)$decade == "182","orange", ifelse(V(com_0554_graph)$decade == "183","gold", ifelse(V(com_0554_graph)$decade == "184","red", ifelse(V(com_0554_graph)$decade == "185","hotpink", ifelse(V(com_0554_graph)$decade == "186","yellow", ifelse(V(com_0554_graph)$decade == "187","black", ifelse(V(com_0554_graph)$decade == "188","tan", "white" ))))))))))))
...
```{r}
G2 <- decomposed_broken_graph[[3]]


V(G2)$color <- ifelse(V(G2)$decade == "177", "blue", ifelse(V(G2)$decade == "178","cyan", ifelse(V(G2)$decade == "179","blueviolet", ifelse(V(G2)$decade == "180","darkgreen", ifelse(V(G2)$decade == "181","green", ifelse(V(G2)$decade == "182","orange", ifelse(V(G2)$decade == "183","gold", ifelse(V(G2)$decade == "184","red", ifelse(V(G2)$decade == "185","hotpink", ifelse(V(G2)$decade == "186","yellow", ifelse(V(G2)$decade == "187","black", ifelse(V(G2)$decade == "188","tan", "white" ))))))))))))
